...
def executeProgram():
    ...
    parser.add_argument("--features",action="store_true",help="I tell the tool to obtain the the training features")
...
#    Run the program.
#	1. Training => --features --config Parameters/p-Training.txt
#	2. Classify     =>  --classify --config Parameters/p-Batch.txt
...
#Ideas: add the following features.
# 5. Think of adding feature combinations.
# 6. Add a dictionary check
# 8. Maybe re-engineer the test and trainig files to drop the beginning indexes.
# 12. Add some visualization operations
# 13. Add other features from the feature spreadsheet.
# 15. Possibility to choose the Machine learning algorithm and test many other ML algorithms and feature combination.
# 18. See if you can add a classifier combination .
# 19. Add Language information in a separate file.
